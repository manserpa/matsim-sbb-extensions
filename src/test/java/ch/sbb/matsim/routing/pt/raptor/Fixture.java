...
/*package*/ class Fixture {
	...
	/*package*/ final GenericRouteFactory genericRouteFactory = new GenericRouteFactory();
	...
	protected void buildRedLine() {
		...
		{ // route from left to right
			NetworkRoute netRoute = (NetworkRoute) linkNetworkRouteFactory.createRoute(this.links[2].getId(), this.links[6].getId());
		...
		{ // route from right to left
			NetworkRoute netRoute = (NetworkRoute) linkNetworkRouteFactory.createRoute(this.links[11].getId(), this.links[15].getId());
			List<Id<Link>> routeLinks = new ArrayList<Id<Link>>();
	...
	protected void buildBlueLine() {
		...
		{ // route from left to right
			NetworkRoute netRoute = (NetworkRoute) linkNetworkRouteFactory.createRoute(this.links[0].getId(), this.links[8].getId());
			List<Id<Link>> routeLinks = new ArrayList<Id<Link>>();
		...
		{ // route from right to left
			NetworkRoute netRoute = (NetworkRoute) linkNetworkRouteFactory.createRoute(this.links[9].getId(), this.links[17].getId());
			List<Id<Link>> routeLinks = new ArrayList<Id<Link>>();
	...
	protected void buildGreenLine() {
		...
		{ // route in circle in clockwise
			NetworkRoute netRoute = (NetworkRoute) linkNetworkRouteFactory.createRoute(this.links[25].getId(), this.links[25].getId());
			List<Id<Link>> routeLinks = new ArrayList<Id<Link>>();
